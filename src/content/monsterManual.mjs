...
export const MONSTER_CATALOGUE = {
  ...
  goblin: {
    ...
    name: "Goblin",
    cr: CR.MINION,
    stats: { hpMax: 7, ac: 13, movementSpeed: 6, attackBonus: 0, damageDice: [1, 4] },
    size: "S",
  ...
  rat: {
    ...
    name: "Giant Rat",
    cr: CR.MINION,
    stats: { hpMax: 4, ac: 10, movementSpeed: 6, attackBonus: -1, damageDice: [1, 2] },
    size: "S",
    abilities: [],
    conditions: [],
    tags: ["beast"],
  ...
  skeleton: {
    ...
    name: "Skeleton",
    cr: CR.MINION,
    stats: { hpMax: 8, ac: 11, movementSpeed: 6, attackBonus: 0, damageDice: [1, 6] },
    size: "M",
    abilities: [],
    conditions: [],
    tags: ["undead"],
  ...
  zombie: {
    ...
    name: "Zombie",
    cr: CR.MINION,
    stats: { hpMax: 12, ac: 8, movementSpeed: 4, attackBonus: 0, damageDice: [1, 6] },
    size: "M",
    abilities: [],
    conditions: [],
    tags: ["undead"],
  ...
  bandit: {
    ...
    name: "Bandit",
    cr: CR.STANDARD,
    stats: { hpMax: 11, ac: 12, movementSpeed: 6, attackBonus: 1, damageDice: [1, 6] },
    size: "M",
    abilities: [],
    conditions: [],
    tags: ["humanoid"],
  ...
  wolf: {
    ...
    name: "Wolf",
    cr: CR.STANDARD,
    stats: { hpMax: 11, ac: 13, movementSpeed: 8, attackBonus: 1, damageDice: [1, 6] },
    size: "M",
    abilities: [],
    conditions: [],
    tags: ["beast", "pack"],
  ...
  cultist: {
    ...
    name: "Cultist",
    cr: CR.STANDARD,
    stats: { hpMax: 9, ac: 12, movementSpeed: 6, attackBonus: 0, damageDice: [1, 4] },
    size: "M",
  ...
  guard: {
    ...
    name: "Town Guard",
    cr: CR.STANDARD,
    stats: { hpMax: 14, ac: 14, movementSpeed: 6, attackBonus: 1, damageDice: [1, 6] },
    size: "M",
  ...
  ogre: {
    ...
    name: "Ogre",
    cr: CR.ELITE,
    stats: { hpMax: 30, ac: 11, movementSpeed: 6, attackBonus: 3, damageDice: [2, 6] },
    size: "L",
    abilities: ["shield_bash"],
    conditions: [],
    tags: ["giant"],
  ...
  dark_knight: {
    ...
    name: "Dark Knight",
    cr: CR.ELITE,
    stats: { hpMax: 25, ac: 16, movementSpeed: 6, attackBonus: 2, damageDice: [1, 8] },
    size: "M",
    abilities: ["shield_bash"],
    conditions: [],
  ...
  mage: {
    ...
    name: "Dark Mage",
    cr: CR.ELITE,
    stats: { hpMax: 18, ac: 12, movementSpeed: 6, attackBonus: 2, damageDice: [1, 6] },
    size: "M",
  ...
  troll: {
    ...
    name: "Troll",
    cr: CR.BOSS,
    stats: { hpMax: 45, ac: 12, movementSpeed: 6, attackBonus: 3, damageDice: [2, 6] },
    size: "L",
    abilities: [],
    conditions: [],
  ...
  dragon_wyrmling: {
    ...
    cr: CR.BOSS,
    stats: { hpMax: 52, ac: 17, movementSpeed: 6, attackBonus: 4, damageDice: [2, 8] },
    size: "M",
    abilities: ["firebolt"],
    conditions: [],
    tags: ["dragon", "fire"],
  ...
  lich: {
    ...
    name: "Lich",
    cr: CR.BOSS,
    stats: { hpMax: 60, ac: 15, movementSpeed: 6, attackBonus: 5, damageDice: [2, 8] },
    size: "M",
