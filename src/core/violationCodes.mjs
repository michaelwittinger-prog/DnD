...
export const V = Object.freeze({
  ...
  // ── Ability system (Phase 6.2) ──────────────────────────────────────
  ABILITY_DUPLICATE_USE_ID:     "ABILITY_DUPLICATE_USE_ID",
  ABILITY_ACTOR_NOT_FOUND:      "ABILITY_ACTOR_NOT_FOUND",
  ABILITY_NOT_KNOWN:            "ABILITY_NOT_KNOWN",
  ABILITY_TARGET_INVALID:       "ABILITY_TARGET_INVALID",
  ABILITY_TARGET_COUNT_INVALID: "ABILITY_TARGET_COUNT_INVALID",
  ABILITY_RANGE_INVALID:        "ABILITY_RANGE_INVALID",
  ABILITY_COST_INSUFFICIENT:    "ABILITY_COST_INSUFFICIENT",
  ABILITY_COOLDOWN_ACTIVE:      "ABILITY_COOLDOWN_ACTIVE",
  ABILITY_PARAMETERS_INVALID:   "ABILITY_PARAMETERS_INVALID",
  ABILITY_RESOLUTION_FAILED:    "ABILITY_RESOLUTION_FAILED",
  ABILITY_TACTICAL_COEXIST:     "ABILITY_TACTICAL_COEXIST",
});
