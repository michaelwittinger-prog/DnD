/**
 * Initial game state for the server — authoritative source of truth.
 * Conforms to shared/schemas/gameState.schema.json.
 * Mirrors the client fixture (sampleGameState) so existing rendering works.
 */
...
/** TypeScript type derived from the initial state shape */
